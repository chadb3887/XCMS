...
class Mobile_Detect
{
	...
	public function mobileGrade()
	{
		...
		if (($this->is('iOS') && (4.3 <= $this->version('iPhone', 'float'))) || ($this->is('iOS') && (4.3 <= $this->version('iPod', 'float'))) || ((2.1 < $this->version('Android', 'float')) && $this->is('Webkit')) || (7.5 <= $this->version('Windows Phone OS', 'float')) || ($this->is('BlackBerry') && (6.0 <= $this->version('BlackBerry', 'float'))) || $this->match('Playbook.*Tablet') || ((1.4 <= $this->version('webOS', 'float')) && $this->match('Palm|Pre|Pixi')) || $this->match('hp.*TouchPad') || ($this->is('Firefox') && (18 <= $this->version('Firefox', 'float'))) || ($this->is('Chrome') && $this->is('AndroidOS') && (4.0 <= $this->version('Android', 'float'))) || ($this->is('Skyfire') && (4.1 <= $this->version('Skyfire', 'float')) && $this->is('AndroidOS') && (2.3 <= $this->version('Android', 'float'))) || ($this->is('Opera') && (11.5 <= $this->version('Opera Mobi', 'float')) && $this->is('AndroidOS')) || $this->is('MeeGoOS') || $this->is('Tizen') || ($this->is('Dolfin') && (2.0 <= $this->version('Bada', 'float'))) || (($this->is('UC Browser') || $this->is('Dolfin')) && (2.3 <= $this->version('Android', 'float'))) || ($this->match('Kindle Fire') || ($this->is('Kindle') && (3.0 <= $this->version('Kindle', 'float')))) || ($this->is('AndroidOS') && $this->is('NookTablet')) || ((16 <= $this->version('Chrome', 'float')) && !$isMobile) || ((5.0 <= $this->version('Safari', 'float')) && !$isMobile) || ((10.0 <= $this->version('Firefox', 'float')) && !$isMobile) || ((7.0 <= $this->version('IE', 'float')) && !$isMobile) || ((10 <= $this->version('Opera', 'float')) && !$isMobile)) {
			return 'A';
		}
		if (($this->is('iOS') && ($this->version('iPhone', 'float') < 4.3)) || ($this->is('iOS') && ($this->version('iPod', 'float') < 4.3)) || ($this->is('Blackberry') && (5 <= $this->version('BlackBerry', 'float')) && ($this->version('BlackBerry', 'float') < 6)) || ((5.0 <= $this->version('Opera Mini', 'float')) && ($this->version('Opera Mini', 'float') <= 7.0) && ((2.3 <= $this->version('Android', 'float')) || $this->is('iOS'))) || $this->match('NokiaN8|NokiaC7|N97.*Series60|Symbian/3') || ((11 <= $this->version('Opera Mobi', 'float')) && $this->is('SymbianOS'))) {
			return 'B';
		}
		if (($this->version('BlackBerry', 'float') <= 5.0) || $this->match('MSIEMobile|Windows CE.*Mobile') || ($this->version('Windows Mobile', 'float') <= 5.2) || ($this->is('iOS') && ($this->version('iPhone', 'float') <= 3.2)) || ($this->is('iOS') && ($this->version('iPod', 'float') <= 3.2)) || (($this->version('IE', 'float') <= 7.0) && !$isMobile)) {
			return 'C';
		}
